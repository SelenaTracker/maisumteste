#!/usr/bin/env python3
"""
Scraper para Selena Gomez & The Scene - Kworb.net
Atualiza: https://kworb.net/spotify/artist/6dJeKm76NjfXBNTpHmOhfO_songs.html
"""
...
def scrape_selena_band():
    """Faz scraping das músicas da Selena Gomez & The Scene"""
    url = "https://kworb.net/spotify/artist/6dJeKm76NjfXBNTpHmOhfO_songs.html"
    ...
    try:
        ...
        print(f"📊 Total de músicas coletadas (banda): {len(songs)}")
        return songs
...
def save_to_json(songs, filename="data_band.json"):
...
def main():
    print("=" * 50)
    print("SCRAPER SELENA GOMEZ & THE SCENE")
    print("=" * 50)
    
    songs = scrape_selena_band()
    
    if songs:
        save_to_json(songs, "data_band.json")
